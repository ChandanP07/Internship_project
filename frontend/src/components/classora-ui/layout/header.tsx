import { UserAvatar } from "@/components/classora-ui/layout/user-avatar";
import { ThemeToggle } from "@/components/classora-ui/theme/theme-toggle";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-64">
        ...
        <DropdownMenuItem asChild>
          <a href={`/faculty/show/${user?.id}`} className="flex items-center gap-2">
