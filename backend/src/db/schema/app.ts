...
export const classes = pgTable(
  "classes",
  {
    ...
    classCode: varchar("class_code", { length: 10 }).unique(),
    inviteCode: varchar("invite_code", { length: 50 }).notNull().unique(), // Keeping for compatibility, but user wants classCode
    name: varchar("name", { length: 255 }).notNull(),
